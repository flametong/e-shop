    ...
    <div class="row">
        ...
        <div class="col-lg-12 category-content">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" id="input-sort">
                                <option
                                    ...
                                    ?>
                                >
                                    <?= getPhrase('category_view_sort_by_default') ?>
                                </option>
                                <option
                                    ...
                                    ?>
                                >
                                    <?= getPhrase('category_view_sort_title_asc') ?>
                                </option>
                                <option
                                    ...
                                    ?>
                                >
                                    <?= getPhrase('category_view_sort_title_desc') ?>
                                </option>
                                <option
                                    ...
                                    ?>
                                >
                                    <?= getPhrase('category_view_sort_price_asc') ?>
                                </option>
                                <option
                                    ...
                                    ?>
                                >
                                    <?= getPhrase('category_view_sort_price_desc') ?>
                                </option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <?php else: ?>
                    <p>
                        <?= getPhrase('category_view_no_products') ?>
                    </p>
                <?php endif; ?>
            </div>
