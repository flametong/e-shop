...
<html lang="en">
<head>
    <base href="<?= getLangCorrectBaseUrl() ?>">
    <meta charset="utf-8">
...
<header class="fixed-top">
                    ...
                    <form action="search">
                        <div class="input-group" id="search">
                            <input
                                    type="text"
                                    class="form-control"
                                    placeholder="<?= getPhrase('tpl_search') ?>"
                                    name="search_query"
                            >
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php else: ?>
                                ...
                                <li>
                                    <a
                                            class="dropdown-item" href="user/logout"
                                    >
                                        <?= getPhrase('tpl_logout') ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                        </ul>
    ...
    <!-- header-bottom -->
    <div class="header-bottom py-2 shadow-sm p-3 bg-white">
        <div class="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid p-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <?php
                        new  Menu([
                            'class' => 'navbar-nav ms-auto mb-2 mb-lg-0 bg-white'
                        ]);
                        ?>
                    </div>
                </div>
